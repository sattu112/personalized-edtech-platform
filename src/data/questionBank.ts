...
export const QUESTION_BANK: Question[] = [
  ...
  // Novice
  { id: 'math-n1', domain: 'mathematics', difficulty: 'Beginner', concept: 'Linear Equations', prompt: 'Solve for x: 2x + 5 = 13', choices: ['x=4', 'x=3', 'x=9', 'x=6'], correctIndex: 0, explanation: '2x = 13−5 = 8, so x = 4.' },
  { id: 'math-n2', domain: 'mathematics', difficulty: 'Beginner', concept: 'Percentages', prompt: 'What is 15% of 200?', choices: ['15', '30', '45', '300'], correctIndex: 1, explanation: '15% × 200 = 0.15 × 200 = 30.' },
  { id: 'math-n3', domain: 'mathematics', difficulty: 'Beginner', concept: 'Exponents', prompt: 'Simplify: 2³ × 2²', choices: ['2⁵', '2⁶', '4⁵', '2¹'], correctIndex: 0, explanation: 'Same base: add exponents. 2^(3+2) = 2⁵ = 32.' },
  // Intermediate
  ...
  // Advanced
  { id: 'math-a1', domain: 'mathematics', difficulty: 'Expert', concept: 'Derivatives', prompt: 'What is the derivative of f(x) = 3x³ − 2x² + 5x − 7?', choices: ['9x² − 4x + 5', '3x² − 2x + 5', '9x² − 4x − 7', '3x³ − 4x + 5'], correctIndex: 0, explanation: 'Power rule term by term: 9x² − 4x + 5.' },
  { id: 'math-a2', domain: 'mathematics', difficulty: 'Expert', concept: 'Integration', prompt: 'Evaluate: ∫(2x + 3) dx', choices: ['x² + 3x + C', '2 + C', 'x² + 3x', '2x² + 3x + C'], correctIndex: 0, explanation: 'Integrate term by term: x² + 3x + C.' },
  { id: 'math-a3', domain: 'mathematics', difficulty: 'Expert', concept: 'Limits', prompt: 'What is lim(x→0) sin(x)/x?', choices: ['0', '1', '∞', 'Undefined'], correctIndex: 1, explanation: 'This is a fundamental limit: lim(x→0) sin(x)/x = 1.' },
  // Mastery
  { id: 'math-m1', domain: 'mathematics', difficulty: 'Expert', concept: 'Multivariable Calculus', prompt: 'For f(x,y) = x²y + sin(xy), what is ∂f/∂x?', choices: ['2xy + y·cos(xy)', 'x² + x·cos(xy)', '2xy + cos(xy)', '2x + sin(xy)'], correctIndex: 0, explanation: 'Treat y as constant: ∂/∂x(x²y) = 2xy, ∂/∂x sin(xy) = y·cos(xy).' },
  { id: 'math-m2', domain: 'mathematics', difficulty: 'Expert', concept: 'Linear Algebra', prompt: 'If A is a 3×3 matrix with det(A) = 2, what is det(2A)?', choices: ['4', '16', '8', '6'], correctIndex: 1, explanation: 'det(kA) = kⁿ · det(A) for an n×n matrix. Here n=3, k=2: 2³ · 2 = 8 · 2 = 16.' },
  { id: 'math-m3', domain: 'mathematics', difficulty: 'Expert', concept: 'Probability Theory', prompt: 'A continuous random variable X has PDF f(x)=2x on [0,1]. What is E[X]?', choices: ['1/2', '2/3', '1/3', '3/4'], correctIndex: 1, explanation: 'E[X] = ∫₀¹ x·2x dx = 2∫₀¹ x² dx = 2/3.' },
  ...
  // Novice
  { id: 'py-n1', domain: 'python', difficulty: 'Beginner', concept: 'List Indexing', prompt: 'What does [10, 20, 30, 40][−1] return?', choices: ['10', '40', 'Error', '−1'], correctIndex: 1, explanation: 'Negative index −1 refers to the last element: 40.' },
  { id: 'py-n2', domain: 'python', difficulty: 'Beginner', concept: 'Dictionaries', prompt: 'What does {"a": 1, "b": 2}.get("c", 0) return?', choices: ['None', '0', 'Error', '"c"'], correctIndex: 1, explanation: 'get() returns the default value 0 since "c" doesn\'t exist.' },
  { id: 'py-n3', domain: 'python', difficulty: 'Beginner', concept: 'Loops', prompt: 'What does [x*2 for x in range(3)] produce?', choices: ['[0, 1, 2]', '[0, 2, 4]', '[2, 4, 6]', '[1, 2, 3]'], correctIndex: 1, explanation: 'range(3) = 0,1,2; doubled: [0, 2, 4].' },
  // Intermediate
  ...
  // Advanced
  { id: 'py-a1', domain: 'python', difficulty: 'Expert', concept: 'Generators', prompt: 'What does the following produce?\n\ngen = (x**2 for x in range(3))\nlist(gen)', choices: ['[0, 1, 4]', '[0, 1, 2]', '<generator object>', 'Error'], correctIndex: 0, explanation: 'Generator expression squares 0,1,2 → [0, 1, 4].' },
  { id: 'py-a2', domain: 'python', difficulty: 'Expert', concept: 'OOP/Inheritance', prompt: 'In Python, what does super().__init__() do?', choices: ['Creates a new object', 'Calls the parent class constructor', 'Deletes the current instance', 'Returns the class name'], correctIndex: 1, explanation: 'super() returns a proxy that delegates method calls to the parent class.' },
  { id: 'py-a3', domain: 'python', difficulty: 'Expert', concept: 'Context Managers', prompt: 'What is the purpose of the `with` statement?', choices: ['Loop iteration', 'Resource management with cleanup', 'Variable scoping', 'Thread synchronization only'], correctIndex: 1, explanation: 'The with statement ensures resources are properly cleaned up via __enter__ and __exit__.' },
  // Mastery
  { id: 'py-m1', domain: 'python', difficulty: 'Expert', concept: 'Metaclasses', prompt: 'What does `type("Foo", (), {})` create?', choices: ['A new function', 'A new class dynamically', 'A module', 'A string "Foo"'], correctIndex: 1, explanation: 'type() with three args dynamically creates a new class named "Foo" with no bases or attributes.' },
  { id: 'py-m2', domain: 'python', difficulty: 'Expert', concept: 'GIL & Concurrency', prompt: 'The Python GIL (Global Interpreter Lock) means:', choices: ['Python cannot use multiple threads at all', 'Only one thread executes Python bytecode at a time', 'Python cannot do multiprocessing', 'All threads share the same memory stack'], correctIndex: 1, explanation: 'The GIL allows only one thread to execute Python bytecode at a time, limiting CPU-bound multithreading.' },
  { id: 'py-m3', domain: 'python', difficulty: 'Expert', concept: 'Descriptors', prompt: 'A descriptor class must define at least which method?', choices: ['__init__', '__get__ (and optionally __set__, __delete__)', '__call__', '__new__'], correctIndex: 1, explanation: 'A descriptor implements __get__, and optionally __set__ and/or __delete__.' },
  ...
  // Novice
  { id: 'ds-n1', domain: 'data-science', difficulty: 'Beginner', concept: 'Pandas Basics', prompt: 'In pandas, what does df.head() return?', choices: ['The last 5 rows', 'The first 5 rows', 'Column names', 'Row indices'], correctIndex: 1, explanation: 'head() returns the first n rows (default 5) of a DataFrame.' },
  { id: 'ds-n2', domain: 'data-science', difficulty: 'Beginner', concept: 'Standard Deviation', prompt: 'A standard deviation of 0 means:', choices: ['The data is perfectly normal', 'All values are the same', 'The mean is 0', 'The data has no mode'], correctIndex: 1, explanation: 'σ=0 means every data point equals the mean — no spread.' },
  { id: 'ds-n3', domain: 'data-science', difficulty: 'Beginner', concept: 'Correlation', prompt: 'A correlation coefficient of −1 indicates:', choices: ['No relationship', 'A perfect positive linear relationship', 'A perfect negative linear relationship', 'A weak relationship'], correctIndex: 2, explanation: '−1 means a perfect negative linear correlation: as one variable increases, the other decreases proportionally.' },
  // Intermediate
  ...
  // Advanced
  { id: 'ds-a1', domain: 'data-science', difficulty: 'Expert', concept: 'Gradient Descent', prompt: 'In gradient descent, the learning rate controls:', choices: ['The number of features', 'The step size of each update', 'The batch size', 'The number of epochs'], correctIndex: 1, explanation: 'The learning rate determines how large each parameter update step is.' },
  { id: 'ds-a2', domain: 'data-science', difficulty: 'Expert', concept: 'Cross-Validation', prompt: 'In k-fold cross-validation, if k=5, each fold serves as the test set:', choices: ['Once', '5 times', 'Never', '10 times'], correctIndex: 0, explanation: 'Each of the 5 folds is used as the test set exactly once, with the other 4 as training.' },
  { id: 'ds-a3', domain: 'data-science', difficulty: 'Expert', concept: 'Classification Metrics', prompt: 'Precision is defined as:', choices: ['TP / (TP + FN)', 'TP / (TP + FP)', '(TP + TN) / Total', '2·(Precision·Recall)/(Precision+Recall)'], correctIndex: 1, explanation: 'Precision = TP/(TP+FP): of all predicted positives, how many were actually positive.' },
  // Mastery
  { id: 'ds-m1', domain: 'data-science', difficulty: 'Expert', concept: 'Bias-Variance Tradeoff', prompt: 'A model with high bias and low variance is typically:', choices: ['Overfitting', 'Underfitting', 'Perfectly balanced', 'Ensemble model'], correctIndex: 1, explanation: 'High bias (too simple) → underfitting; low variance → consistent but inaccurate predictions.' },
  { id: 'ds-m2', domain: 'data-science', difficulty: 'Expert', concept: 'PCA', prompt: 'PCA (Principal Component Analysis) is primarily used for:', choices: ['Classification', 'Dimensionality reduction', 'Time series forecasting', 'Data imputation'], correctIndex: 1, explanation: 'PCA reduces dimensionality by projecting data onto principal components that maximize variance.' },
  { id: 'ds-m3', domain: 'data-science', difficulty: 'Expert', concept: 'Bayesian Inference', prompt: 'In Bayes\' theorem, P(H|E) represents:', choices: ['The prior probability', 'The posterior probability', 'The likelihood', 'The marginal probability'], correctIndex: 1, explanation: 'P(H|E) is the posterior: probability of hypothesis H given evidence E.' },
];
